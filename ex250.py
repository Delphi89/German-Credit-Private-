...
from Utillities3 import Utillities
from cnn_model4 import CNN6     
...
if OPTIMIZATION_PLUGIN == 'Bayesian' :
    ...
    def objective(SCI_RELU, SCI_BIAS, SCI_loss_type,
                  ...
                  SCI_LINEARITY, SCI_BN_EPS, SCI_BN_STATS, SCI_LAST_LAYER, SCI_ACT_LAYER):
        ...
        Utillities.listing(optimizer, SCI_SGD_MOMENTUM, SCI_BN_MOMENTUM, 
                           ...
                           SCI_BATCH_SIZE, SCI_DROPOUT, SCI_LINEARITY, SCI_LAST_LAYER, SCI_ACT_LAYER)
        ...
        for epoch in range(SCI_EPOCHS):
            ...
            with torch.no_grad():
                for step, (validation_data, validation_target) in enumerate(validation_loader):
                    ...
                    output, temp = cnn(validation_data)      
