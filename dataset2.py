...
class dataset:
    ...
    train_data, train_target = CreateImageDataset(file[0], TRAIN_SIZE, LAST_DATA_ELEMENT)
    validation_data, validation_target = CreateImageDataset(file[1], VALIDATION_SIZE, LAST_DATA_ELEMENT)
    test_data, test_target = CreateImageDataset(file[2], TEST_SIZE, LAST_DATA_ELEMENT)
