...
class CNN6(nn.Module):
    ...
    def __init__(self, L_FIRST, SCI_L_SECOND, KERNEL_X, SCI_BIAS, SCI_BN_MOMENTUM, SCI_RELU, SCI_DROPOUT, CLASSES, SCI_BN_EPS, SCI_BN_STATS, SCI_LAST_LAYER, SCI_ACT_LAYER):
        ...
        self.linear_1 = nn.Sequential(                  
            ...
            nn.Conv2d(L_FIRST, SCI_L_SECOND, kernel_size = (1, KERNEL_X), padding = (0,0), padding_mode = 'reflect', bias=SCI_BIAS),
        ...
        self.linear_2 = nn.Sequential(                  
            nn.BatchNorm2d(SCI_L_SECOND, eps=SCI_BN_EPS, momentum=SCI_BN_MOMENTUM, affine=True, track_running_stats=SCI_BN_STATS), 
            nn.Conv2d(SCI_L_SECOND, SCI_L_SECOND, kernel_size = (1, KERNEL_X),  padding = (0,0), padding_mode = 'reflect', bias=SCI_BIAS),
            CNN6.ACTIVATION_LAYER(SCI_ACT_LAYER, SCI_RELU),
        )      
        ...
        self.linear_22 = nn.Sequential(   
            nn.BatchNorm2d(SCI_L_SECOND, eps=SCI_BN_EPS, momentum=SCI_BN_MOMENTUM, affine=True, track_running_stats=SCI_BN_STATS),
            nn.Conv2d(SCI_L_SECOND, SCI_L_SECOND, kernel_size = (1, KERNEL_X),  padding = (1,0), padding_mode = 'reflect', bias=SCI_BIAS),
            CNN6.ACTIVATION_LAYER(SCI_ACT_LAYER, SCI_RELU), 
            nn.BatchNorm2d(SCI_L_SECOND, eps=SCI_BN_EPS, momentum=SCI_BN_MOMENTUM, affine=True, track_running_stats=SCI_BN_STATS),        
        ...
        self.linear_23 = nn.Sequential(   
            nn.BatchNorm2d(SCI_L_SECOND, eps=SCI_BN_EPS, momentum=SCI_BN_MOMENTUM, affine=True, track_running_stats=SCI_BN_STATS),
            nn.Conv2d(SCI_L_SECOND, SCI_L_SECOND, kernel_size = (1, KERNEL_X),  padding = (2,0), padding_mode = 'reflect', bias=SCI_BIAS),
            CNN6.ACTIVATION_LAYER(SCI_ACT_LAYER, SCI_RELU), 
            nn.BatchNorm2d(SCI_L_SECOND, eps=SCI_BN_EPS, momentum=SCI_BN_MOMENTUM, affine=True, track_running_stats=SCI_BN_STATS),        
        ...
        self.linear_3 = nn.Sequential(
            nn.Linear(SCI_L_SECOND*20, CLASSES, bias=SCI_BIAS),
            CNN6.LAST_LAYER(SCI_LAST_LAYER)
        )   

    def forward(self, x): 
        x1 = self.linear_1(x) 
        x2 = self.linear_2(x1) + self.linear_21(x1) 
        x3 = self.linear_22(x2) + self.linear_23(x2)
        x4 = x3 + x2
        x5 = x4.view(x4.size(0), -1)
        output = self.linear_3(x5)
        return output  
